...
I co-founded and co-lead NOAA's Model Diagnostics Task Force, a community initiative that has developed over 50 diagnostic tools to evaluate climate models based on fundamental processes. This framework is now used by both NOAA-GFDL and NCAR and contributes to a growing community of practitioners working on systematic model evaluation.  The task force plays an important role in connecting the academic community with the national laboratories conducting model development, fostering collaborations, and providing modeling centers with key insights into stakeholder needs to guide further model development.
