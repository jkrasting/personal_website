...
const publications = defineCollection({
  ...
  schema: ({ image }) => z.object({
    ...
    // Custom fields for publications filtering
    researchAreas: z.array(z.string()).optional(),
    firstAuthor: z.boolean().optional(),
    impactFactor: z.number().optional(),
    status: z.enum(['published', 'accepted', 'in-review', 'in-prep']).optional(),
    ...
    // Mentoring and collaboration fields
    mentoredUndergrad: z.boolean().optional(),
    mentoredPostdoc: z.boolean().optional(),
    coPI: z.boolean().optional(),
    supervisedStaff: z.boolean().optional(),
  }),
});
